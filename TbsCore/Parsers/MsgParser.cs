...
namespace TravBotSharp.Files.Parsers
{
    ...
    {
        public static int UnreadMessages(HtmlDocument htmlDoc, Classificator.ServerVersionEnum version)
        {
            switch (version)
            {
                case Classificator.ServerVersionEnum.T4_4:
                    ...
                    var msgCount = container.Descendants("div").FirstOrDefault(x => x.HasClass("speechBubbleContent"))
                        .InnerHtml;

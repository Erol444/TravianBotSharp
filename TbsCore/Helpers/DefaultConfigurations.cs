...
namespace TravBotSharp.Files.Helpers
{
    public static class DefaultConfigurations
    {
        ...
        public static void FarmVillagePlan(Account acc, Village vill)
        {
            ...
            BuildingHelper.AddBuildingTask(acc, vill, new BuildingTask() { TaskType = BuildingHelper.BuildingType.General, Building = Classificator.BuildingEnum.MainBuilding, BuildingId = 26, Level = 5 });
            ...
            BuildingHelper.AddBuildingTask(acc, vill, new BuildingTask() { TaskType = BuildingHelper.BuildingType.General, Building = Classificator.BuildingEnum.MainBuilding, BuildingId = 26, Level = 10 });

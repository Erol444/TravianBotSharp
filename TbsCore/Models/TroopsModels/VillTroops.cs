...
namespace TbsCore.Models.TroopsModels
{
    ...
    {
        public int
            Settlers { get; set; } // For settling new village. TODO: make creation of new villages more error-proof

        public Classificator.TroopsEnum?
            TroopToTrain { get; set; } //for high speed servers where you only train 1 troop type

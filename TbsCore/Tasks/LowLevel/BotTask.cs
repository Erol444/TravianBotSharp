...
namespace TravBotSharp.Files.Tasks
{
    public abstract class BotTask
    {
        ...
        /// <summary>
        ///     After each execution, if return bool is true, there has to be a new browser load event. Bot will wait for that
        ///     event.
        ///     If there is no browser load event (just parsing some data eg. GetMapSize, return false and browser will navigate to
        ///     dorf1/2.
        /// </summary>

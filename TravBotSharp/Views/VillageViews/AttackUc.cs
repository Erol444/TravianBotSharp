...
namespace TravBotSharp.Views
{
    ...
    {
        private readonly List<List<SendWaveModel>> sendWaves = new List<List<SendWaveModel>>();
        ...
        public void UpdateUc()
        {
            ...
            foreach (var sendWaveTask in sendWaveTasks)
            {
                ...
                item.SubItems.Add(firstWave.TargetCoordinates.x + "/" +
                                  firstWave.TargetCoordinates.y); //target coordinates
        ...
        private string GetWaveType(SendWaveModel attk)
        {
            ...
            if (attk.Troops.Any(x => x < 0)) return "Real attack";
            return "Catas";
        }
    }
}